...
import pe.edu.upeu.microservice_schedule.infrastructure.adapter.out.persistence.mapper.WeekDayMapper;
...
public class WeekDayRepositoryAdapter implements WeekDayRepositoryPort {
    
    private final WeekDayJpaRepository jpaRepository;
    private final WeekDayMapper mapper;

    @Override
    public WeekDay save(WeekDay weekDay) {
        var entity = mapper.toEntity(weekDay);
