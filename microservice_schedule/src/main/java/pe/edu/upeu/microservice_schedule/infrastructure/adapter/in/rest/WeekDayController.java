...
import pe.edu.upeu.microservice_schedule.infrastructure.adapter.in.rest.mapper.WeekDayDtoMapper;
...
public class WeekDayController {
    ...
    private final WeekDayUseCase useCase;
    private final WeekDayDtoMapper mapper;

    @PostMapping
    public ResponseEntity<WeekDayResponse> create(@Valid @RequestBody WeekDayRequest request) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<WeekDayResponse> findById(@PathVariable Long id) {
    ...
    @GetMapping
    public ResponseEntity<List<WeekDayResponse>> findAll() {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<WeekDayResponse> update(
            @PathVariable Long id,
            @Valid @RequestBody WeekDayRequest request) {
        var domain = mapper.toDomain(request);
